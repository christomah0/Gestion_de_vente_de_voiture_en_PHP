<div class="fixed z-10 inset-0 overflow-y-auto hidden" id="m-modal">
    <div class="flex items-center justify-center min-h-screen">
        ...
        <div class="bg-white overflow-hidden shadow-xl transform transition-all sm:w-full sm:mx-auto max-w-md text-gray-600 rounded">
            ...
            <div class="p-4">
                <form action=<?php echo $urlOfModifyModal; ?> method="post" id="m-client-form">
                    <div class="flex gap-1 my-2">
                        <div class="flex-1 flex flex-col">
                            <label for="m-client-id">ID</label>
                            <input type="text" class="focus:border-blue-400 focus:bg-white bg-gray-200 hover:bg-white hover:border-gray-300 focus:outline-none pl-1 py-1 border rounded modal-input" id="m-client-id" name="m-client-id" required autocomplete="off">
                        </div>
                        <div class="flex-1 flex flex-col">
                            <label for="m-client-name">Nom</label>
                            <input type="text" class="focus:border-blue-400 focus:bg-white bg-gray-200 hover:bg-white hover:border-gray-300 focus:outline-none pl-1 py-1 border rounded modal-input" id="m-client-name" name="m-client-name" required autocomplete="off">
                        </div>
                    </div>
                    <div class="flex flex-col my-2">
                        <label for="m-client-contact">Contact</label>
                        <input type="text" class="focus:border-blue-400 focus:bg-white bg-gray-200 hover:bg-white hover:border-gray-300 focus:outline-none pl-1 py-1 border rounded modal-input" id="m-client-contact" name="m-client-contact" required autocomplete="off">
                    </div>
